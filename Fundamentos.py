...
def nuevoTema4(tema):
    print(f"\n-----   {tema}  -----\n")
    llave_a = "{" #Se pueden crear fvariables para signos que podrian confuncdirse con los comandos del lenguaje. 
...
nuevoTema3("Operadores aritméticos") # usando una "cadena formateada"
nuevoTema4("Operadores aritméticos") # incluyendo otras variables.